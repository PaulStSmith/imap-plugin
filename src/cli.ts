...
account
  ...
  .option("--credential-provider <provider>", "local-keychain, 1password, env, sql-vault, or dev-sql-vault")
  .option("--credential-ref <ref>", "1Password op:// reference, environment variable name, or dev SQL vault secret reference")
  .option("--password <password>", "Password for local-keychain or SQL vault storage")
